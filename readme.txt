...
If you do decide to use a child theme with Sitepoint Based, there's no need to use CSS @import or even enqueue the parent stylesheet. Sitepoint Based will automatically enqueue the parent stylesheet for you. Cool eh!
...
If you're looking to build an eCommerce website, Sitepoint Based supports the excellent WooCommerce plugin, straight out of the box.
...
Widgets are a great way of adding extra content to your site and Sitepoint Based has a whole assortment of them.
...
Use the following instructions to install & activate Sitepoint Based using your preferred method.

Manual installation:

1. Unzip the files from the Sitepoint Based zip file that you downloaded
2. Upload the Sitepoint Based folder to your /wp-content/themes/ directory
3. Click on the Appearance > Themes menu option in the WordPress Dashboard
4. Click the Activate link below the Sitepoint Based preview thumbnail
...
4. Click the Install Now link below the Sitepoint Based preview thumbnail
...
Since Sitepoint Based is a starter theme to kick off your own awesome theme, the first thing you want to do is copy the Sitepoint Based theme folder
...
1. Search for Sitepoint Based inside single quotations to capture the text domain.
2. Search for sitepointbasetheme_ to capture all the function names.
3. Search for Sitepoint Based with a space before it to replace all the occurrences of it in comments.
